...
const blank = { showCategoryId: '', posterMediaAssetId: null, featuredMediaAssetId: null, durationMinutes: '', productionYear: '', ageRecommendation: '', originalLanguage: '', trailerUrl: '', videoUrl: '', premiereDate: '', lifecycleStatus: 'Upcoming', isFeatured: false, galleryMedia: [], translations: [blankTranslation('sq'), blankTranslation('en')] }
...
export function ShowEditorPage() {
  ...
  const deletePlay = async () => {
    if (!await dialog.confirm({ title: 'Delete play permanently?', message: `“${translation('sq').title || 'This play'}” will be permanently removed. This cannot be undone.`, confirmLabel: 'Delete permanently', danger: true })) return
    try {
