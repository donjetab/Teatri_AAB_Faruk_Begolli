...
export function SubscribersPage() {
  ...
  const remove = async item => { if (!window.confirm(`Permanently delete subscriber data for ${item.email}?`)) return; await adminApi.deleteSubscriber(item.id); setToast('Subscriber data deleted.'); load() }
